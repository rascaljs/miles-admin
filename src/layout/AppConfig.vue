...
const onChangeTheme = (theme: string, mode: string) => {
  ...
  if (linkElement) {
    ...
    const newThemeUrl: string = linkElement.getAttribute('href')!.replace(layoutConfig.theme, theme);
    ...
    <template v-if="!simple">
      ...
      <div class="flex">
        <div class="field-radiobutton flex-1">
          <RadioButton v-model="layoutConfig.menuMode" name="menuMode" value="static" input-id="mode1"></RadioButton>
          <label for="mode1">Static</label>
        </div>

        <div class="field-radiobutton flex-1">
          <RadioButton v-model="layoutConfig.menuMode" name="menuMode" value="overlay" input-id="mode2"></RadioButton>
